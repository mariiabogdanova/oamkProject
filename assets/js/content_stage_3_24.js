...
var l3link = {
    Domestic_Abuse_AND_Violence: {
        deeplinks: [{
            link: {
                title: "Get Support",
                url: "https://www.liveandworkwell.com/default.asp?programPIN=40078&redirectURL=/member/library/showBucket.asp?tid=3~bid=86~lang=1"
            }
        }],
    ...
    Emotional_and_Mental_Health_AND_Trauma: {
        deeplinks: [{
            link: {
                title: "Get Support",
                url: "http://www.liveandworkwell.com/default.asp?programPIN=40078&redirectURL=/member/library/showBucket.asp?tid=3~bid=61~lang=1"
            }
        }],
    ...
    Substance_Abuse_AND_Addiction: {
        deeplinks: [{
            link: {
                title: "Get Support",
                url: "http://www.liveandworkwell.com/default.asp?programPIN=40078&redirectURL=/member/library/showTopic.asp?tid=3~lang=1"
            }
        }],
    ...
    Terminal_Illness_AND_Death: {
        deeplinks: [{
            link: {
                ...
                url: "http://www.liveandworkwell.com/default.asp?programPIN=40078&redirectURL=/member/library/showBucket.asp?tid=3~bid=63~lang=1"
            }
        }, {
            link: {
                title: "Will Planning",
    ...
    Legal_Concerns: {
        deeplinks: [{
            link: {
                ...
                url: "https://www.liveandworkwell.com/default.asp?programPIN=40078&redirectURL=/member/library/showBucket.asp?tid=1~bid=138~lang=1"
            }
        }],
        search_tags: '',
    ...
    Building_Stronger_Relationships: {
        deeplinks: [{
            link: {
                ...
                url: "https://www.liveandworkwell.com/default.asp?programPIN=40078&redirectURL=/member/library/showBucket.asp?tid=1~bid=123~lang=1"
            }
        }],
    ...
    Family_Planning_AND_Fertility: {
        deeplinks: [{
            link: {
                ...
                url: "https://www.liveandworkwell.com/default.asp?programPIN=40078&redirectURL=/member/library/showTopic.asp?tid=1~lang=1"
            }
        }, {
            link: {
    ...
    Breaking_Up_OR__Separation_AND_Divorce: {
        deeplinks: [{
            link: {
                title: "Breaking Up",
                url: "https://www.liveandworkwell.com/default.asp?programPIN=40078&redirectURL=/member/library/showBucket.asp?tid=1~bid=114~lang=1"
            }
        }, {
            link: {
                title: "Legal Aid",
    ...
    LiveandWorkwellcom: {
        deeplinks: [{
            link: {
                ...
                url: "https://LiveandWorkwell.com/default.asp?programPIN=40078&redirectURL=/member/default.asp?lang=1"
            }
        }],
        search_tags: '',
    ...
    Solving_Stress: {
        deeplinks: [{
            ...
            link: {
                title: "LiveandWorkWell.com",
                url: "https://www.liveandworkwell.com/default.asp?programPIN=40078&redirectURL=/member/library/showBucket.asp?tid=3~bid=108~lang=1"
            }
        }],
    ...
    Healthy_Living: {
        deeplinks: [{
            link: {
                ...
                url: "https://www.liveandworkwell.com/default.asp?programPIN=40078&redirectURL=/member/library/showTopic.asp?tid=3~lang=1"
            }
        }, {
            link: {
                title: "Rally",
    ...
    Time_Management: {
        deeplinks: [{
            link: {
                ...
                url: "https://www.liveandworkwell.com/default.asp?programPIN=40078&redirectURL=/member/library/showBucket.asp?tid=2~bid=36~lang=1"
            }
        }, {
            link: {
                title: "meQ",
    ...
    Adapting_to_and_Embracing_Change: {
        deeplinks: [{
            link: {
                ...
                url: "https://www.liveandworkwell.com/default.asp?programPIN=40078&redirectURL=/member/library/showBucket.asp?tid=3~bid=62~lang=1"
            }
        }, {
            link: {
                title: "meQ",
    ...
    Personal_Growth_AND_Development: {
        deeplinks: [{
            link: {
                ...
                url: "https://www.liveandworkwell.com/default.asp?programPIN=40078&redirectURL=/member/library/showTopic.asp?tid=2~lang=1"
            }
        }],
    ...
    Workplace_Relationships: {
        deeplinks: [{
            link: {
                ...
                url: "https://www.liveandworkwell.com/default.asp?programPIN=40078&redirectURL=/member/library/showBucket.asp?tid=2~bid=42~lang=1"
            }
        }, {
            link: {
                title: "meQ",
    ...
    Difficult_Conversations: {
        deeplinks: [{
            link: {
                ...
                url: "https://www.liveandworkwell.com/default.asp?programPIN=40078&redirectURL=/member/library/showBucket.asp?tid=2~bid=176~lang=1"
            }
        }],
        search_tags: '',
